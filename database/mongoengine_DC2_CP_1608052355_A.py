...
class Background(Document):
    ...
    data_science_techniques = ListField(StringField(required=True),
                                        default=list)
    last_time_committed_code = StringField(max_length=5, 
                                           choices=(('Today', 'Today'),
...
# Users
class User(General_info, Social, Engagement, Community, Experience, Background):
    user_id = StringField()
    notes = StringField()
...
# <> match reqs w/ candidate questions
